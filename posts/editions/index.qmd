...
author: Sean Greaves
description: Building a map of Deliveroo's UK Editions sites with web-scraping
date: '2023-07-24'
draft: false
...
Dedicated sites for preparing takeaway meals for delivery only known as "dark kitchens" have become a widely adopted model in the food service industry throughout the past half decade. Dark kitchens enable a restaurant's delivery business to be seperated from in-house business and operated from non-residential central locations where overhead and operating costs are reduced. Understanding the successes and failures of this service model could provide useful insights into emerging forms of economic planning, risk management, urban design and food distribution. However there is a lack of detailed data on the growth and current state of dark kitchens within the UK.
